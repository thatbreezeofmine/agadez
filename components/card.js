...
export default function Card(props) {
    ...
    return (
        <div title={props.product.name} className={`group rounded-agadez w-48 h-72 lg:w-64 lg:h-96`} style={{backgroundImage : `url(${props.product.image_url})`, backgroundSize : "cover", backgroundPosition: "center"}}>
